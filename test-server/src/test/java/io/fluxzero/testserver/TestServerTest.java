...
import io.fluxzero.javaclient.tracking.handling.HandleCustom;
import io.fluxzero.javaclient.tracking.handling.HandleDocument;
...
import io.fluxzero.javaclient.tracking.metrics.DisableMetrics;
import io.fluxzero.javaclient.tracking.metrics.ProcessBatchEvent;
import lombok.Value;
