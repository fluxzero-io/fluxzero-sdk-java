...
@Slf4j
public final class TestServerVersion {
    private static final String VERSION_KEY = "version";
    private static final String VERSION_RESOURCE = "/META-INF/fluxzero/test-server.version";
    private static final String POM_PROPERTIES_RESOURCE = "/META-INF/maven/io.fluxzero/test-server/pom.properties";
        ...
        if (!versionResolved) {
            synchronized (TestServerVersion.class) {
                if (!versionResolved) {
                    ...
                    if (version == null) {
                        log.warn("Could not determine Fluxzero runtime version from packaged build metadata. "
