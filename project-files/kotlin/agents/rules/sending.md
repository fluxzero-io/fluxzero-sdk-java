...
Prefer `ScheduleId` when different schedule categories can share a domain ID, and reuse the same typed value for
scheduling, lookup and cancellation. Fluxzero persists its stable `type:id` representation.
