...
// Frozen compatibility oracle from 78d08f06b8d:common/src/main/java/io/fluxzero/common/api/modeling/ModelStreamBatchDecoder.java.
...
public final class LegacyModelStreamBatchDecoder {

    private static final int VERSION = 7;

    private LegacyModelStreamBatchDecoder() {
    }
