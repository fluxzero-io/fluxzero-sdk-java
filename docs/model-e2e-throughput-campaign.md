...
| Next evidence target | explain and remove the route feedback that fragments 131,072 conflict-free updates into 37 serial model/event commits instead of a few full commits; retain one ordinary atomic durability lane until evidence proves a different boundary |
