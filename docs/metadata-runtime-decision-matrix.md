...
| handler.discovery | Which executable is a handler method or constructor | Hybrid | Generated invocation plan | `ExecutableDescriptor` now, invocation plan in Slice 3 |
