...
| modeling.apply-assert | `@Apply`, `@AssertLegal`, and trigger filters | Generated invocation plan | Generated invocation plan | Metadata filters plus generated invocation backend; normal JVM compatibility fallback is outside generated-only mode | Done |
| modeling.property-access | Reading/writing JVM object properties and constructing entities | Generated invocation plan | Generated invocation plan | `GeneratedPropertyAccesses` and generated constructor invocations; normal JVM property backend is outside generated-only mode | Done |
...
| web.parameter-binding | Path/query/header/cookie/form/body parameter metadata and dynamic path roots | Generated invocation plan | Generated invocation plan | `ExecutableView`/`ParameterView` metadata plus web parameter/body binding descriptors and JVM web context mechanics | Done |
