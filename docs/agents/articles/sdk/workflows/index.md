...
- Use a Model when the workflow is naturally one domain consistency boundary. Add namespaced `@Alias` fields for alternate Model lookup.
...
- Keep a simple reaction stateless when all progress can be derived from existing Model state.
