...
remain unchanged. This is an intentional SDK 2.0 compatibility break. Coordinate document conversion and Runtime
upgrades before cutover; readers without a ZSTD decoder cannot read the new document representation.
