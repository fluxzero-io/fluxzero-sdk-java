...
Find answers to the most common questions about Fluxzero. Can't find what you're looking for? [Join our community](https://github.com/orgs/fluxzero-io/discussions) or [open an issue](https://github.com/fluxzero-io/fluxzero-sdk-java/issues).

<CardGrid>
<LinkCard
  title="🚀 Getting Started"
  href="#getting-started"
  description="New to Fluxzero? Start here for basics about what it is and how to begin."
/>

<LinkCard
  title="🏗️ Technical Architecture"
  href="#technical-architecture"
  description="Deep dive into how Fluxzero works under the hood and architectural decisions."
/>

<LinkCard
  title="💻 Building & Testing"
  href="#building--testing"
  description="How your coding agent builds, and how to inspect and test Fluxzero products."
/>

<LinkCard
  title="🚢 Deployment & Operations"
  href="#deployment--operations"
  description="Production deployment, scaling, monitoring, and operational concerns."
/>

<LinkCard
  title="🔄 Migration & Comparison"
  href="#migration--comparison"
  description="Moving from other frameworks and how Fluxzero compares to alternatives."
/>
</CardGrid>
...
<details>
<summary>**Do I need to be a developer to build with Fluxzero?**</summary>

No. The easiest way to start is to [copy one instruction into your coding agent](/get-started). You decide what the product should do, while the agent works in the application code and Fluxzero handles the backend foundation.
...
No. Event sourcing is the default model load strategy, but you can start with model commits without understanding its internals and learn advanced persistence patterns later.
...
Models use event sourcing by default and may instead load current state from a synchronously maintained direct document. Both modes can store and publish model events.
...
When you change message or model structures, follow the versioning and upcasting guidance to preserve persisted-data compatibility.
