...
The complete, unmodified NLDigital Terms 2025 below are attached to these Platform Terms as Schedule 1 and form part of the Agreement.

<p>
  <a href="/legal/nldigital-terms-2025-en.pdf">Open Schedule 1 as a PDF</a>
</p>

<object
  data="/legal/nldigital-terms-2025-en.pdf"
  type="application/pdf"
  width="100%"
  height="900"
  aria-label="Schedule 1 - NLDigital Terms 2025"
>
  <p>
    Your browser cannot display the attached PDF. <a href="/legal/nldigital-terms-2025-en.pdf">Open Schedule 1 as a PDF</a>.
  </p>
</object>
