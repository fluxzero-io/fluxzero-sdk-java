...
**2.5** Fluxzero's availability, performance, and data protection obligations apply only to the ZeroOps Cloud.
...
**6.2** In addition to the exclusions in the [NLDigital Terms 2025](#schedule-1---nldigital-terms-2025), Fluxzero is not liable for damage resulting from: (i) Customer's Application Code, Applications, or configurations; (ii) Customer's use of AI coding tools or AI-generated code; (iii) failure to follow Documentation or security instructions; (iv) third-party services or infrastructure used by Customer; or (v) acts or omissions of Fluxzero's infrastructure providers.
...
- Customer's use of AI coding tools or AI-generated code; or
...
**10.11** Fluxzero shall only transfer personal data outside the European Economic Area in accordance with Chapter 5 of the GDPR and on the documented instruction of the Customer.
