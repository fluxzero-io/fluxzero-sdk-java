---
title: Installation
description: Start building with a coding agent, generate a project, or install Fluxzero yourself.
sidebar:
   order: 20
...
If you prefer not to install the CLI, you can generate a project using the form below.
