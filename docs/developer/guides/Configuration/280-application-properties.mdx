...
| `>= 2026.09.25` | `fluxzero.model.packedSubsteps = true` | Advertise lossless packed Model membership v8 to supporting Runtimes. Set `false` to retain the v7/full-membership fallback. Environment variable: `FLUXZERO_MODEL_PACKED_SUBSTEPS`. |
