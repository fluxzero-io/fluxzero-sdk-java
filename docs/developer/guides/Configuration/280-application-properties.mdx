...
| `>= 2026.09.25` | `fluxzero.publishing.defaultGuarantee = STORED` | Publication and send-and-forget defaults await durable delivery at the consumer batch boundary. Set `NONE` for compatibility or `SENT` for transport completion. |
