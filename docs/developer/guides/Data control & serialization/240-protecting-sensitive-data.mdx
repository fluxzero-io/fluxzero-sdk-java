...
Message-field protection does not extend to secrets copied into Model state or documents. For eventless current
state, query visibility, authorization and erasure boundaries, start with
[Model state: persistence and protection boundaries](/docs/guides/modeling-and-persistence/model-state-boundaries/).
