---
title: Parent-owned schedules
description: Bind delayed work to a committed Model lifetime and cancel it automatically on deletion.
slug: docs/guides/messaging/parent-owned-schedules
sidebar:
   order: 86
---
