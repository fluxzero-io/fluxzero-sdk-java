...
native outbound requests allow normal JDK redirects, WebSocket reconnects use a fixed one-second interval, and
aggregate-history pages are count-bounded only.
