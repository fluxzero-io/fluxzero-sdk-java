 ...
 *
 * @param registry component registry used as lookup source
 */
public record RegistryComponentMetadataLookup(ComponentRegistry registry) implements ComponentMetadataLookup {

    public RegistryComponentMetadataLookup {
        registry = Objects.requireNonNull(registry, "registry").normalized();
    }
