 ...
 * <p>
 * Scheduled messages may originate from an explicit schedule call, or from a payload annotated with the Fluxzero
 * periodic scheduling annotation, which
 ...
 * <ul>
 *     <li><b>{@code null}</b>: continue scheduling using the default strategy if the schedule is periodic.</li>
 ...
 *         with the periodic annotation, the periodic settings on that payload take precedence.</li>
 ...
 * </ul>
 * <p>
 * To cancel a periodic schedule, throw a {@link io.fluxzero.sdk.scheduling.CancelPeriodic} exception.
 *
 ...
 * }
 * }</pre>
 * If {@code PollUpdates} is annotated as periodic, its delay or cron expression will be used for rescheduling.
 *
