...
public enum MessageType {
    ...
    MessageType(boolean request, boolean response) {
        this.request = request;
        this.response = response;
    }

    /**
     * Returns whether this message type expects a response.
     */
    ...
    /**
     * Returns whether this message type represents a response to a request.
     */
