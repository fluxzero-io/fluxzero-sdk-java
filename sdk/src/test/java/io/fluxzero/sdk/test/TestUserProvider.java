 ...
 * This provider is active by default in {@link io.fluxzero.sdk.test.TestFixture} instances.
 * If you wish to test behavior with unauthenticated users (e.g., as they would be seen in a real web request),
 * call {@link io.fluxzero.sdk.test.TestFixture#withProductionUserProvider()} to re-enable the production
