...
public class RequestAnnotationProcessorTest {
    ...
    void testRequestWithCorrectType() {
        ...
        Reflect.compile(
                "io.fluxzero.sdk.tracking.handling.CorrectHandler",
                """
                            package io.fluxzero.sdk.tracking.handling;
                            public class CorrectHandler {
                                @io.fluxzero.sdk.tracking.handling.HandleQuery
                                String handle(io.fluxzero.sdk.tracking.handling.RequestAnnotationProcessorTest.MockQuery query) {
                                    return "foo";
                                }
                            }
    ...
    void testRequestWithCorrectFutureType() {
        ...
        Reflect.compile(
                ...
                """
                            ...
                            public class CorrectHandler {
                                @io.fluxzero.sdk.tracking.handling.HandleQuery
                                java.util.concurrent.Future<String> handle(io.fluxzero.sdk.tracking.handling.RequestAnnotationProcessorTest.MockQuery query) {
    ...
    void testRequestWithWrongTypeAllowedIfPassive() {
        RequestAnnotationProcessor p = new RequestAnnotationProcessor();
        Reflect.compile(
                "io.fluxzero.sdk.tracking.handling.PassiveHandler",
                """
                            package io.fluxzero.sdk.tracking.handling;
                            public class PassiveHandler {
                                @io.fluxzero.sdk.tracking.handling.HandleQuery(passive = true)
                                Boolean handle(io.fluxzero.sdk.tracking.handling.RequestAnnotationProcessorTest.MockQuery query) {
                                    return true;
                                }
                            }
                        """, new CompileOptions().processors(p)
    ...
    void testRequestWithWrongReturnType() {
        ...
        assertThrows(ReflectException.class, () -> Reflect.compile(
                "io.fluxzero.sdk.tracking.handling.WrongHandler",
                """
                            package io.fluxzero.sdk.tracking.handling;
    ...
    void testPayloadHandlerWithCorrectType() {
        RequestAnnotationProcessor p = new RequestAnnotationProcessor();
        Reflect.compile(
                "io.fluxzero.sdk.tracking.handling.CorrectPayloadHandler",
                """
                            package io.fluxzero.sdk.tracking.handling;
                            public class CorrectPayloadHandler implements io.fluxzero.sdk.tracking.handling.Request<String> {
                                @io.fluxzero.sdk.tracking.handling.HandleQuery
                                String handle() {
                                    return "foo";
                                }
    ...
    class ExtendedRequestTests {
        ...
        void testStringRequestWithCorrectType() {
            ...
            Reflect.compile(
                    ...
                    """
                                package io.fluxzero.sdk.tracking.handling;
                                public class CorrectPayloadHandler implements io.fluxzero.sdk.tracking.handling.RequestAnnotationProcessorTest.ExtendedRequestTests.StringRequest {
                                    @io.fluxzero.sdk.tracking.handling.HandleQuery
                                    String handle() {
                                        return "foo";
                                    }
        ...
        void testExtendedRequestWithCorrectType() {
            ...
            Reflect.compile(
                    ...
                    """
                                package io.fluxzero.sdk.tracking.handling;
                                public class CorrectPayloadHandler implements io.fluxzero.sdk.tracking.handling.RequestAnnotationProcessorTest.ExtendedRequestTests.ExtendedRequest<String> {
                                    @io.fluxzero.sdk.tracking.handling.HandleQuery
                                    String handle() {
                                        return "foo";
                                    }
