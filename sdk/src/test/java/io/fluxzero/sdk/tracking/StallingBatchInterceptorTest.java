...
class StallingBatchInterceptorTest {
    ...
    private final TestFixture testFixture =
            TestFixture.createAsync(DefaultFluxzero.builder().disableAutomaticAggregateCaching()
                    ...
                    c -> c.toBuilder().batchInterceptor(
                            ...
                            .build())).suppressPendingConsumerWarning()
                    .spy().consumerTimeout(Duration.ofMillis(100)).registerHandlers(handler);
