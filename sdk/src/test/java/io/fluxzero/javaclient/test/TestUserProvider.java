 ...
 * This provider is active by default in {@link io.fluxzero.javaclient.test.TestFixture} instances.
 * If you wish to test behavior with unauthenticated users (e.g., as they would be seen in a real web request),
 * call {@link io.fluxzero.javaclient.test.TestFixture#withProductionUserProvider()} to re-enable the production
 ...
 *
 * @see UserProvider
 * @see io.fluxzero.javaclient.test.TestFixture#withProductionUserProvider()
 */
@AllArgsConstructor
