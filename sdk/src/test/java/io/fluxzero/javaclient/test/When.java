...
import io.fluxzero.javaclient.web.HttpRequestMethod;
 ...
 * deserialized using {@link io.fluxzero.common.serialization.JsonUtils}.
 * <p>
...
public interface When {
    ...
    /**
     * Executes the provided action using the {@link Fluxzero} instance and validates its side effects.
     * <p>
     ...
     */
    default Then<?> whenExecuting(ThrowingConsumer<Fluxzero> action) {
    ...
    /**
     * Executes the provided function using the {@link Fluxzero} instance and validates its result and/or side effects.
     *
     * @param action action to execute
     * @param <R>    result type
     * @return expectation for result and/or side effects
     */
    <R> Then<R> whenApplying(ThrowingFunction<Fluxzero, R> action);
