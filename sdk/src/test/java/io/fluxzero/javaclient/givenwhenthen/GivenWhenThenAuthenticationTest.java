...
package io.fluxzero.javaclient.givenwhenthen;

import io.fluxzero.common.api.Metadata;
import io.fluxzero.javaclient.configuration.DefaultFluxzero;
import io.fluxzero.javaclient.givenwhenthen.forbidsadmin.ForbidsAdminViaPackage;
import io.fluxzero.javaclient.givenwhenthen.requiresadmin.RequiresAdminViaPackage;
import io.fluxzero.javaclient.givenwhenthen.requiresadmin.subpackage.RequiresAdminViaParentPackage;
import io.fluxzero.javaclient.givenwhenthen.requiresuser.NoUserRequiredOverride;
import io.fluxzero.javaclient.givenwhenthen.requiresuser.RequiresAdminOverride;
import io.fluxzero.javaclient.givenwhenthen.requiresuser.RequiresUserViaPackage;
...
import io.fluxzero.javaclient.tracking.handling.authentication.AbstractUserProvider;
import io.fluxzero.javaclient.tracking.handling.authentication.FixedUserProvider;
import io.fluxzero.javaclient.tracking.handling.authentication.ForbidsAnyRole;
import io.fluxzero.javaclient.tracking.handling.authentication.ForbidsUser;
import io.fluxzero.javaclient.tracking.handling.authentication.MockUser;
import io.fluxzero.javaclient.tracking.handling.authentication.RequiresAnyRole;
import io.fluxzero.javaclient.tracking.handling.authentication.RequiresUser;
import io.fluxzero.javaclient.tracking.handling.authentication.UnauthenticatedException;
import io.fluxzero.javaclient.tracking.handling.authentication.UnauthorizedException;
...
public class GivenWhenThenAuthenticationTest {
    ...
    private final TestFixture testFixture = TestFixture.create(
            DefaultFluxzero.builder().registerUserProvider(new FixedUserProvider(() -> user)), new MockHandler(),
