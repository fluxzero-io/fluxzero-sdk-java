...
class GivenWhenThenTest {
    ...
    @Test
    void testFluxzeroInstanceAvailableOutsideTestFixture() {
        assertEquals(testFixture.getFluxzero(), Fluxzero.instance.get());
    }
    ...
    private static class EventHandler {
        ...
        public void handle(Object event) {
            Fluxzero.sendCommand(new YieldsNoResult());
        }
    }
