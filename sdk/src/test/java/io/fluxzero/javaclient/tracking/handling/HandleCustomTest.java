...
public class HandleCustomTest {
    ...
    @Test
    void withUser() {
        TestFixture.create(DefaultFluxzero.builder().registerUserProvider(new FixedUserProvider(() -> new MockUser("test"))), new Handler())
    ...
    static class Handler {
        ...
        void handleCustomEvent(String input) {
            Fluxzero.publishEvent("custom: " + input);
            Fluxzero.get().customGateway("other").sendAndForget(input);
        }
