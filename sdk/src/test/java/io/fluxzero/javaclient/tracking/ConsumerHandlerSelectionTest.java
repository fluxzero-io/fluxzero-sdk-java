...
import io.fluxzero.javaclient.tracking.root.RootHandler;
import io.fluxzero.javaclient.tracking.root.level2.Level2Handler;
import io.fluxzero.javaclient.tracking.root.level2.level3.Level3Handler;
import io.fluxzero.javaclient.tracking.root.level2.level3.Level3HandlerWithCustomConsumer;
...
public class ConsumerHandlerSelectionTest {
    ...
    private final TestFixture testFixture = TestFixture.createAsync(
            DefaultFluxzero.builder().addConsumerConfiguration(
