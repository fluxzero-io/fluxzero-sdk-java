...
package io.fluxzero.javaclient.common.serialization.casting;
...
public class GivenWhenThenUpcasterChainTest {
    ...
    public static class JsonNodeUpcaster {
        @Upcast(type = "io.fluxzero.javaclient.common.serialization.casting.GivenWhenThenUpcasterChainTest$CreateModel",
                revision = 0)
        public ObjectNode upcast(ObjectNode input) {
            return input.put("content", "patchedContent");
        }

        @Upcast(type = "io.fluxzero.javaclient.common.serialization.casting.GivenWhenThenUpcasterChainTest$DroppedCreateModel",
                revision = 0)
