 ...
 * Use {@link io.fluxzero.sdk.Fluxzero#customGateway(String)} to create or retrieve a
...
public interface GenericGateway extends Namespaced<GenericGateway>, HasLocalHandlers, AutoCloseable {
    ...
    /**
     * Truncates this gateway's message log and clears associated tracking positions using {@link Guarantee#DEFAULT}.
     *
     * @return a {@link CompletableFuture} that completes according to the selected delivery guarantee
     */
    default CompletableFuture<Void> truncate() {
        return truncate(Guarantee.DEFAULT);
    }
