 ...
 *   <li>{@link #FORM} – Extracted from URL-encoded form fields or multipart form parts</li>
...
public enum WebParameterSource {
    ...
    /**
     * Form fields ({@code application/x-www-form-urlencoded}) or multipart parts ({@code multipart/form-data})
     */
    FORM,
