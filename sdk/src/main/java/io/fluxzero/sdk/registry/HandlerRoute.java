...
public record HandlerRoute(
        ...
        boolean local,
        boolean tracked,
        @NonNull Set<String> payloadTypeNames,
        @NonNull Set<String> allowedClassNames,
        @NonNull List<WebRouteDescriptor> webRoutes) {
    ...
    private static boolean isAssignable(String typeName, Class<?> payloadType) {
        try {
            ClassLoader classLoader = Optional.ofNullable(payloadType.getClassLoader())
