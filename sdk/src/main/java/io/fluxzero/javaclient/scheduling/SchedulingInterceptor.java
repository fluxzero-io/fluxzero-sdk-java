...
package io.fluxzero.javaclient.scheduling;
...
import static io.fluxzero.javaclient.Fluxzero.currentIdentityProvider;
import static io.fluxzero.javaclient.scheduling.CronExpression.parseCronExpression;
import static io.fluxzero.javaclient.tracking.IndexUtils.millisFromIndex;
 ...
 *     with {@link io.fluxzero.javaclient.scheduling.Periodic}, this interceptor will automatically initialize the
 ...
 *
 * <p>
 * Additionally, if the scheduled handler throws a {@link io.fluxzero.javaclient.scheduling.CancelPeriodic} exception,
 * the schedule is permanently cancelled without logging an error.
 *
 * <p>
 * This interceptor is registered automatically with {@link Fluxzero}.
 *
 * @see io.fluxzero.javaclient.scheduling.Periodic
 * @see io.fluxzero.javaclient.scheduling.CancelPeriodic
 * @see io.fluxzero.javaclient.scheduling.Schedule
 */
@Slf4j
public class SchedulingInterceptor implements DispatchInterceptor, HandlerInterceptor {
    ...
    protected void initializePeriodicSchedule(Class<?> payloadType, Periodic periodic) {
        ...
        if (periodic.autoStart()) {
            ...
            Instant firstDeadline = firstDeadline(periodic, fluxzero.clock().instant());
