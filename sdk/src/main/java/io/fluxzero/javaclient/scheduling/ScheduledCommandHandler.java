...
import static io.fluxzero.javaclient.common.serialization.UnknownTypeStrategy.IGNORE;
 ...
 * {@link io.fluxzero.javaclient.publishing.DispatchInterceptor dispatch interceptors} are invoked. Many
 ...
 * {@link io.fluxzero.javaclient.common.serialization.DeserializingMessage} context.
 * <p>
 * If deserialization fails (e.g. due to an unknown type or missing class), the command is appended directly to the
 * lower level {@link io.fluxzero.javaclient.publishing.client.GatewayClient command gateway client} using a raw
 ...
 * @see io.fluxzero.javaclient.tracking.handling.HandleSchedule
 * @see Fluxzero#scheduleCommand
 */
@Consumer(name = "ScheduledCommandHandler", typeFilter = "\\Qio.fluxzero.javaclient.scheduling.ScheduledCommand\\E")
