...
import static io.fluxzero.javaclient.Fluxzero.currentTime;
 ...
 * <ul>
 *   <li><strong>Deferring arbitrary payloads</strong> (to be handled via {@link io.fluxzero.javaclient.tracking.handling.HandleSchedule}).</li>
 ...
 *
 * <h2>Typical usage</h2>
 * This interface underpins the static helpers in {@link io.fluxzero.javaclient.Fluxzero}, such as:
 * <pre>
