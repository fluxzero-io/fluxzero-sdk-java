...
public class Schedule extends Message {
    ...
    public Schedule(Object payload, Instant deadline) {
        this(payload, Fluxzero.currentIdentityProvider().nextTechnicalId(), deadline);
    }
    ...
    public Schedule reschedule(Duration duration) {
        return new Schedule(getPayload(), getMetadata(), Fluxzero.currentIdentityProvider().nextTechnicalId(), currentTime(),
