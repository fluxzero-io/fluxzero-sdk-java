...
package io.fluxzero.javaclient.persisting.search;
 ...
 * it to be stored and queried using {@link io.fluxzero.javaclient.persisting.search.DocumentStore}.
 * <p>
 ...
 * <ul>
 *     <li>{@link io.fluxzero.javaclient.Fluxzero#index(Object)}</li>
 *     <li>{@link io.fluxzero.javaclient.persisting.search.DocumentStore}</li>
 * </ul>
 *
 * @see io.fluxzero.javaclient.persisting.search.DocumentStore
 * @see io.fluxzero.javaclient.persisting.search.IndexOperation
 */
@Documented
