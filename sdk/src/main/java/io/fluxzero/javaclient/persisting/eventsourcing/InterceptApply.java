...
import io.fluxzero.javaclient.modeling.AssertLegal;
 ...
 *     <li>Context like {@link io.fluxzero.common.api.Metadata}, {@link io.fluxzero.javaclient.common.Message}, or
 *         {@link io.fluxzero.javaclient.tracking.handling.authentication.User}</li>
 * </ul>
 *
 * <p>
 ...
 * enclosing {@link io.fluxzero.javaclient.modeling.Aggregate @Aggregate} or specific
 * {@link Apply @Apply} method is configured with
 * {@link io.fluxzero.javaclient.modeling.EventPublication#IF_MODIFIED IF_MODIFIED}.
