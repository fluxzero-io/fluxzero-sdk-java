...
package io.fluxzero.javaclient.persisting.eventsourcing.client;
 ...
 * <ul>
 *   <li>{@link io.fluxzero.javaclient.persisting.eventsourcing.EventStore}</li>
 *   <li>{@link io.fluxzero.javaclient.persisting.repository.AggregateRepository}</li>
 *   <li>Static methods on {@link io.fluxzero.javaclient.Fluxzero}, e.g. {@code Fluxzero.loadAggregate(...)}.</li>
 * </ul>
 *
 ...
 * </ul>
 *
 * @see io.fluxzero.javaclient.persisting.eventsourcing.EventStore
 * @see io.fluxzero.javaclient.persisting.repository.AggregateRepository
 */
