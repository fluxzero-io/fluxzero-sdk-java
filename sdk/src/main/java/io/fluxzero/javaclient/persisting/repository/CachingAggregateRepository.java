...
import static io.fluxzero.javaclient.modeling.Entity.getAggregateId;
import static io.fluxzero.javaclient.modeling.Entity.getAggregateType;
import static io.fluxzero.javaclient.tracking.client.DefaultTracker.start;
 ...
 * log.
 * <p>
 * This repository starts an internal {@link io.fluxzero.javaclient.tracking.client.TrackingClient} that tails the
 ...
 * @see Entity
 * @see io.fluxzero.javaclient.tracking.client.TrackingClient
 */
