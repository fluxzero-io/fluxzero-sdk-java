...
package io.fluxzero.javaclient.persisting.caching;

import lombok.Value;

/**
 * Represents an eviction from a {@link Cache}.
 * <p>
 * These events are typically emitted when a cached object is removed from memory due to expiration, memory pressure,
 * manual eviction, or cache size constraints.
 * <p>
 ...
 * @see io.fluxzero.javaclient.publishing.MetricsGateway
 */
@Value
public class CacheEviction {
    /**
     * The identifier of the evicted object. May be null if the entire cache was cleared.
     */
    Object id;

    /**
     * The value of the evicted object. <strong>Note: </strong>This may be null if the cache implementation supports
     * soft references and the value has been removed from memory or after clearing of the entire cache.
     */
    Object value;
