...
/**
 * Handles incoming HTTP {@code TRACE} requests for the specified path(s).
 * <p>
 * This is a specialization of {@link HandleWeb} for {@code TRACE} method requests.
 * </p>
 *
 * @see HandleWeb
 */
...
@HandleWeb(value = "", method = HttpRequestMethod.TRACE)
