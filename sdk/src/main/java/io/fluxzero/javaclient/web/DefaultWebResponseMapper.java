...
import io.fluxzero.javaclient.common.serialization.DeserializationException;
...
import io.fluxzero.javaclient.tracking.handling.validation.ValidationException;
        ...
        if (response instanceof Throwable) {
            if (response instanceof ValidationException || response instanceof DeserializationException) {
                ...
                builder.status(403).payload(((Exception) response).getMessage());
                       ...
                       || response instanceof io.fluxzero.javaclient.publishing.TimeoutException) {
