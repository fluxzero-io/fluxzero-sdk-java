...
/**
 * Handles incoming HTTP {@code PATCH} requests for the specified path(s).
 * <p>
 * This is a specialization of {@link HandleWeb} for {@code PATCH} method requests.
 * </p>
 *
 * @see HandleWeb
 */
...
@HandleWeb(value = "", method = HttpRequestMethod.PATCH)
