 ...
 * {@link io.fluxzero.javaclient.configuration.FluxzeroBuilder#forwardWebRequestsToLocalServer(int)} is
 ...
 * <h2>How It Works</h2>
 * <ul>
 *   <li>Consumes {@code WEBREQUEST} messages via a {@link io.fluxzero.javaclient.tracking.Tracker}</li>
 ...
 * </ul>
 *
 * @see io.fluxzero.javaclient.configuration.FluxzeroBuilder#forwardWebRequestsToLocalServer(int)
 * @see io.fluxzero.javaclient.web.WebRequest
 * @see io.fluxzero.javaclient.web.WebResponse
 * @see io.fluxzero.javaclient.tracking.Tracker
 */
@Slf4j
