...
/**
 * Configuration for the local HTTP server used to handle {@code WebRequest} messages outside of Fluxzero's own
 ...
 * third-party locally running HTTP server (e.g., Spring MVC, Javalin, etc.) instead of the built-in Fluxzero web
 * stack.
 * <p>
