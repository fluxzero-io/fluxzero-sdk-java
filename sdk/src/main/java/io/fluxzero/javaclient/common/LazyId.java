...
package io.fluxzero.javaclient.common;
 ...
 * <p>
 * If the ID is not provided directly, a supplier (e.g., {@code Fluxzero::generateId}) can be used to compute it
...
public class LazyId {
    ...
    /**
     * Constructs a new {@code LazyId} with a default ID supplier using {@code Fluxzero::generateId}.
     */
    public LazyId() {
