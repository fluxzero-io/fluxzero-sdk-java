 ...
 * {@link io.fluxzero.javaclient.modeling.EntityId}) inside the {@code Task} class.
 *
 ...
 *         Flux locates the identifier via the {@link io.fluxzero.javaclient.modeling.EntityId} annotation.</li>
 *
 ...
 * </ul>
 *
 * @see io.fluxzero.javaclient.modeling.EntityId
 * @see io.fluxzero.javaclient.modeling.Aggregate
 * @see io.fluxzero.javaclient.persisting.eventsourcing.Apply
 * @see io.fluxzero.javaclient.modeling.AssertLegal
 */
@Documented
