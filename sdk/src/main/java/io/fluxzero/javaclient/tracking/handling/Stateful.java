 ...
 * By default, the {@link io.fluxzero.javaclient.persisting.search.DocumentStore} is used.
 * <ul>
 ...
 * {@code @Stateful} handlers may optionally include a {@link io.fluxzero.javaclient.tracking.Consumer} annotation
 * to define their own tracking configuration (e.g. isolation, concurrency, retry policy).
 *
 * @see Association
 * @see EntityId
 * @see io.fluxzero.javaclient.tracking.Consumer
 */
@Documented
