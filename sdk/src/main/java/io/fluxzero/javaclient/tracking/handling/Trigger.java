 ...
 * <ul>
 *   <li>{@link io.fluxzero.javaclient.tracking.handling.HandleResult @HandleResult} handlers to access the original request</li>
 *   <li>{@link io.fluxzero.javaclient.tracking.handling.HandleError @HandleError} handlers to inspect the command or query that failed</li>
 * </ul>
 *
 * <p>
 * It can be placed on:
 ...
 *       <li>{@link io.fluxzero.javaclient.common.Message Message}</li>
 *       <li>{@link io.fluxzero.javaclient.common.serialization.DeserializingMessage DeserializingMessage}</li>
 *     </ul>
 *   </li>
 ...
 * </ul>
 *
 * @see io.fluxzero.javaclient.tracking.handling.HandleResult
 * @see io.fluxzero.javaclient.tracking.handling.HandleError
 */
...
public @interface Trigger {
    ...
    /**
     * Restricts the trigger by its {@link io.fluxzero.common.MessageType}.
     */
