 ...
 * {@link io.fluxzero.javaclient.tracking.Consumer#handlerInterceptors()}, or applied programmatically using the
 ...
 * }</pre>
 *
 * @see io.fluxzero.javaclient.tracking.Consumer#handlerInterceptors()
