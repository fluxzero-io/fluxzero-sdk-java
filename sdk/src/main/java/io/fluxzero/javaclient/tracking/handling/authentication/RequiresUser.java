...
package io.fluxzero.javaclient.tracking.handling.authentication;
 ...
 * <ul>
 *   <li>A message handler will only be invoked if {@link io.fluxzero.javaclient.tracking.handling.authentication.User#getCurrent()}
 *       is not {@code null}.</li>
 *   <li>If placed on a message payload, a {@link io.fluxzero.javaclient.tracking.handling.authentication.UnauthenticatedException}
 ...
 *
 * @see RequiresAnyRole
 * @see io.fluxzero.javaclient.tracking.handling.authentication.User
 * @see io.fluxzero.javaclient.tracking.handling.authentication.UnauthenticatedException
 */
@Documented
