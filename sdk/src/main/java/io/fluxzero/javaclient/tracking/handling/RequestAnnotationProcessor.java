...
@SupportedAnnotationTypes({
        ...
        "io.fluxzero.javaclient.tracking.handling.HandleCommand",
        "io.fluxzero.javaclient.tracking.handling.HandleCustom"})
...
public class RequestAnnotationProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        TypeMirror requestType = getTypeUtils().erasure(getElementUtils().getTypeElement(
                "io.fluxzero.javaclient.tracking.handling.Request").asType());
