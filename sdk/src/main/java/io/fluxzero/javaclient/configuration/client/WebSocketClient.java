...
package io.fluxzero.javaclient.configuration.client;
...
import io.fluxzero.javaclient.persisting.eventsourcing.client.WebSocketEventStoreClient;
import io.fluxzero.javaclient.persisting.keyvalue.client.KeyValueClient;
import io.fluxzero.javaclient.persisting.keyvalue.client.WebsocketKeyValueClient;
import io.fluxzero.javaclient.persisting.search.client.SearchClient;
import io.fluxzero.javaclient.persisting.search.client.WebSocketSearchClient;
import io.fluxzero.javaclient.publishing.client.GatewayClient;
import io.fluxzero.javaclient.publishing.client.WebsocketGatewayClient;
import io.fluxzero.javaclient.scheduling.client.SchedulingClient;
import io.fluxzero.javaclient.scheduling.client.WebsocketSchedulingClient;
import io.fluxzero.javaclient.tracking.client.CachingTrackingClient;
import io.fluxzero.javaclient.tracking.client.TrackingClient;
import io.fluxzero.javaclient.tracking.client.WebsocketTrackingClient;
...
import static io.fluxzero.javaclient.common.websocket.ServiceUrlBuilder.eventSourcingUrl;
import static io.fluxzero.javaclient.common.websocket.ServiceUrlBuilder.gatewayUrl;
import static io.fluxzero.javaclient.common.websocket.ServiceUrlBuilder.keyValueUrl;
import static io.fluxzero.javaclient.common.websocket.ServiceUrlBuilder.schedulingUrl;
import static io.fluxzero.javaclient.common.websocket.ServiceUrlBuilder.searchUrl;
import static io.fluxzero.javaclient.common.websocket.ServiceUrlBuilder.trackingUrl;
 ...
 * }</pre>
 *
 * @see io.fluxzero.javaclient.configuration.DefaultFluxzero#builder()
 * @see Client
