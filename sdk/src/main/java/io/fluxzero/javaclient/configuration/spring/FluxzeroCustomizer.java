...
/**
 * Callback interface that can be implemented by Spring beans to customize the {@link FluxzeroBuilder}
 * before it is used to build the main {@link Fluxzero} instance.
 * <p>
