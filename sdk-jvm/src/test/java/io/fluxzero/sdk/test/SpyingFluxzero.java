 ...
 * <p>
 * This class is used internally by {@link io.fluxzero.sdk.test.TestFixture#spy()} to enable verification
 ...
 *     <li>{@link AsyncCommandGateway}</li>
 *     <li>{@link AsyncQueryGateway}</li>
...
public class SpyingFluxzero implements Fluxzero {
    ...
    @Override
    public AsyncCommandGateway commandGateway() {
        return decorate(delegate.commandGateway());
    }

    @Override
    public AsyncQueryGateway queryGateway() {
