...
/**
 * Default implementation of the {@link AsyncCommandGateway} interface.
 * <p>
 ...
 *
 * @see AsyncCommandGateway
 * @see GenericGateway
 */
@AllArgsConstructor
public class DefaultCommandGateway implements AsyncCommandGateway {
    @Delegate
    @With
    private final GenericGateway delegate;

    @Override
    public DefaultCommandGateway forDefaultNamespace() {
