 ...
 * <p>
 * Uses {@link Fluxzero#currentClock()} to get the index corresponding to the current timestamp of Fluxzero's
 * internal clock.
 */
public class IndexUtils {
     ...
     * @return the maximum index corresponding to the provided time in the Fluxzero index space
     */
    ...
    /**
     * Calculates an index based on the current timestamp from Fluxzero's internal clock. The method uses the
    ...
    public static long indexForCurrentTime() {
        return Fluxzero.currentClock().millis() << 16;
    }
